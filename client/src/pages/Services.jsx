...
const services = [
  {
    ...
    price: '2,499',
    icon: <Star size={28} />,
    features: ['8 Hours Coverage', '2 Lead Photographers', '500+ Edited Photos', 'Engagement Session', 'Premium Photo Album'],
  },
  {
    title: 'Fine Art Portraits',
    tagline: 'Soulful Studies',
    price: '599',
    icon: <Camera size={28} />,
    features: ['2 Hours Session', 'Personalized Concept', '20 High-End Retouches', 'Styling Consultation', 'Private Online Gallery'],
  },
  {
    title: 'Events & Corporate',
    tagline: 'Dynamic Coverage',
    price: '1,299',
    icon: <Clock size={28} />,
    features: ['Half Day Coverage', '48h Turnaround', 'Full Content License', 'Branding Focused', 'Candid Specialists'],
  },
];
