...
const reviews = [
  { name: 'Eleanor & Thomas', event: 'Heritage Wedding',  text: 'A truly breathtaking experience. DREAMDAY WEDDING PHOTOGRAPHY captured the essence of our wedding in a way we never thought possible. The cinematic approach is just on another level.', rating: 5, tag: 'Wedding' },
  ...
  { name: 'Aria Editorial',   event: 'Fashion Campaign',  text: 'Professional, punctual, and highly creative. The photographers at DREAMDAY WEDDING PHOTOGRAPHY have an incredible eye for shadows and composition.', rating: 5, tag: 'Commercial' },
