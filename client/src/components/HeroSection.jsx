...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* ── Adaptive overlay ── */}
      <div className="hero-adaptive-overlay light-overlay" />

      {/* ── Top bar ── */}
      <div className="hero-topbar">
        <Link to="/" className="hero-logo">
          <img src="/logo.png" alt="DREAMDAY WEDDING PHOTOGRAPHY" className="hero-logo-img" />
          <div className="hero-logo-text">
            <span className="hero-brand-name">DREAMDAY WEDDING PHOTOGRAPHY</span>
            <span className="hero-brand-sub">Photography</span>
          </div>
        </Link>
